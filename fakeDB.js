const productos = [
  ...
  },
  {
    ...
    nombre: 'Teclado mecanico para gaming Hyperex Alloy origins RGB Switch blue en español',
    descripcionCorta: 'Graphics Processing GeForce® GTX 1650 Core Clock',
    descripcionLarga: '',
    precio: 1280,
    existencia: true
  ...
  },
  {
    ...
    nombre: 'Silla para gaming Naceb Black Ops descansa brazos 3D lumbar',
    descripcionCorta: 'Graphics Processing GeForce® GTX 1650 Core Clock',
    descripcionLarga: '',
    precio: 4799,
    precioOferta: 8750,
